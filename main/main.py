...
class CycleGAN:
    ...
    def compute_losses(self):
        ...
        *_summ -> Summary variables for above loss functions
        ...
        '''
            Add on mask loss
        '''
        loss_A_mask = losses.mask_loss(self.masks[0], self.input_a_mask)
        loss_B_mask = losses.mask_loss(self.masks[1], self.input_b_mask)
        loss_mask = loss_A_mask+loss_B_mask
        ...
        self.AB_mask = optimizer.minimize(loss_mask, var_list=g_Ae_vars+g_Be_vars)
    ...
    def save_images(self, sess, epoch, curr_tr):
        ...
        names = ['inputA_', 'inputB_', 'fakeA_',
                 'fakeB_', 'cycA_', 'cycB_',
                 'mask_a', 'mask_b', 'mask_a_real', 'mask_b_real']
        ...
        with open(os.path.join(
            ...
            for i in range(0, self._num_imgs_to_save):
                ...
                tensors = [inputs['images_i'], inputs['images_j'],
                           fake_B_temp, fake_A_temp, cyc_A_temp, cyc_B_temp, masks[0], masks[1], inputs['images_i_mask'],inputs["images_j_mask"]]
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(sess.run(self.global_step), self._max_step):
                ...
                saver.save(sess, os.path.join(
                    self._output_dir, "OurGAN"), global_step=epoch)
                ...
                for i in range(0, max_images):
                    ...
                    _, fake_B_temp, smask_a,summary_str,_ = sess.run(
                        [to_train_A,
                         self.fake_images_b,
                         self.masks[0],
                         self.g_A_loss_summ,
                        ...
                        feed_dict={
                            ...
                            self.input_b:
                                inputs['images_j'],
                            self.input_a_mask:
                                inputs['images_i_mask'],
                            self.input_b_mask:
                                inputs['images_j_mask'],
                    ...
                    _, fake_A_temp, smask_b, summary_str,_ = sess.run(
                        [to_train_B,
                         self.fake_images_a,
                         self.masks[1],
                         self.g_B_loss_summ,
...
def parse_args():
    ...
    parser.add_argument('--log_dir',
              type=str,
              default="./output/test_4_4",
              help='Where the data is logged to.')

    parser.add_argument('--config_filename', type=str, default='./configs/exp_01.json', help='The name of the configuration file.')
